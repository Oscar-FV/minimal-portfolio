    ...
    <>
      <div className="h-1/5 flex justify-center items-end">
        <div className="tracking-[6px] w-[12rem] lg:w-[24rem]">
          ...
          <h2 className="text-xl lg:text-4xl whitespace-pre-wrap text-accent">
            Software Developer
          </h2>
        </div>

        <div className="border-[10px] border-primary h-[9rem] lg:h-[15rem] w-[9rem] lg:w-[15rem] text-white flex items-center justify-center ">
